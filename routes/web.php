...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('images/ckmedia', 'ImagesController@storeCKEditorImages')->name('images.storeCKEditorImages');
    ...
    Route::post('order-details/parse-csv-import', 'OrderDetailController@parseCsvImport')->name('order-details.parseCsvImport');
    Route::post('order-details/process-csv-import', 'OrderDetailController@processCsvImport')->name('order-details.processCsvImport');
    ...
    // Product Options
    Route::delete('product-options/destroy', 'ProductOptionController@massDestroy')->name('product-options.massDestroy');
    Route::resource('product-options', 'ProductOptionController');

    // Option Groups
    Route::delete('option-groups/destroy', 'OptionGroupController@massDestroy')->name('option-groups.massDestroy');
    Route::resource('option-groups', 'OptionGroupController');

    // Customer Supports
    Route::delete('customer-supports/destroy', 'CustomerSupportController@massDestroy')->name('customer-supports.massDestroy');
    Route::post('customer-supports/media', 'CustomerSupportController@storeMedia')->name('customer-supports.storeMedia');
    Route::post('customer-supports/ckmedia', 'CustomerSupportController@storeCKEditorImages')->name('customer-supports.storeCKEditorImages');
    Route::post('customer-supports/parse-csv-import', 'CustomerSupportController@parseCsvImport')->name('customer-supports.parseCsvImport');
    Route::post('customer-supports/process-csv-import', 'CustomerSupportController@processCsvImport')->name('customer-supports.processCsvImport');
    Route::resource('customer-supports', 'CustomerSupportController');

    // Slide Types
    Route::delete('slide-types/destroy', 'SlideTypeController@massDestroy')->name('slide-types.massDestroy');
    Route::resource('slide-types', 'SlideTypeController');
    ...
    // Top Menus
    Route::delete('top-menus/destroy', 'TopMenuController@massDestroy')->name('top-menus.massDestroy');
    Route::post('top-menus/media', 'TopMenuController@storeMedia')->name('top-menus.storeMedia');
    Route::post('top-menus/ckmedia', 'TopMenuController@storeCKEditorImages')->name('top-menus.storeCKEditorImages');
    Route::resource('top-menus', 'TopMenuController');

    // Footer Menus
    Route::delete('footer-menus/destroy', 'FooterMenuController@massDestroy')->name('footer-menus.massDestroy');
    Route::post('footer-menus/media', 'FooterMenuController@storeMedia')->name('footer-menus.storeMedia');
    Route::post('footer-menus/ckmedia', 'FooterMenuController@storeCKEditorImages')->name('footer-menus.storeCKEditorImages');
    Route::resource('footer-menus', 'FooterMenuController');
