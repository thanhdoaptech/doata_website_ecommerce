...
class ProductCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = ProductCategory::with(['created_by'])->select(sprintf('%s.*', (new ProductCategory)->table));
        ...
        return view('admin.productCategories.index', compact('users'));
    }
    ...
    public function edit(ProductCategory $productCategory)
    {
        ...
        $productCategory->load('created_by');
