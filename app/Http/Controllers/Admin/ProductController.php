...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Product::with(['categories', 'tags', 'locations', 'created_by'])->select(sprintf('%s.*', (new Product)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'category', 'tag', 'photo', 'location']);
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('categories', 'tags', 'locations'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('categories', 'tags', 'locations', 'created_by');

        return view('admin.products.edit', compact('categories', 'tags', 'locations', 'product'));
    }
