...
class OrderDetailApiController extends Controller
{
    public function index()
    {
        ...
        return new OrderDetailResource(OrderDetail::with(['orders', 'products', 'created_by'])->get());
    }
    ...
    public function show(OrderDetail $orderDetail)
    {
        ...
        return new OrderDetailResource($orderDetail->load(['orders', 'products', 'created_by']));
    }
