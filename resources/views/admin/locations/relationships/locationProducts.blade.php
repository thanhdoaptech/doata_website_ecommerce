...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-locationProducts">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($products as $key => $product)
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                @foreach($product->locations as $key => $item)
                                    <span class="badge badge-info">{{ $item->name }}</span>
                                @endforeach
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-locationProducts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
