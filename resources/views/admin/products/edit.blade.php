...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="min_price">{{ trans('cruds.product.fields.min_price') }}</label>
                <input class="form-control {{ $errors->has('min_price') ? 'is-invalid' : '' }}" type="number" name="min_price" id="min_price" value="{{ old('min_price', $product->min_price) }}" step="0.01" required>
                @if($errors->has('min_price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('min_price') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.min_price_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="max_price">{{ trans('cruds.product.fields.max_price') }}</label>
                <input class="form-control {{ $errors->has('max_price') ? 'is-invalid' : '' }}" type="number" name="max_price" id="max_price" value="{{ old('max_price', $product->max_price) }}" step="0.01" required>
                @if($errors->has('max_price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('max_price') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.max_price_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="locations">{{ trans('cruds.product.fields.location') }}</label>
                <div style="padding-bottom: 4px">
                    <span class="btn btn-info btn-xs select-all" style="border-radius: 0">{{ trans('global.select_all') }}</span>
                    <span class="btn btn-info btn-xs deselect-all" style="border-radius: 0">{{ trans('global.deselect_all') }}</span>
                </div>
