    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_price') ? 'is-invalid' : '' }}" type="number" name="min_price" id="min_price" value="{{ old('min_price', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_price') ? 'is-invalid' : '' }}" type="number" name="max_price" id="max_price" value="{{ old('max_price', '') }}" step="0.01" required>
