    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $order->amount) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ship_name') ? 'is-invalid' : '' }}" type="text" name="ship_name" id="ship_name" value="{{ old('ship_name', $order->ship_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ship_address') ? 'is-invalid' : '' }}" type="text" name="ship_address" id="ship_address" value="{{ old('ship_address', $order->ship_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ship_address_2') ? 'is-invalid' : '' }}" type="text" name="ship_address_2" id="ship_address_2" value="{{ old('ship_address_2', $order->ship_address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $order->city) }}" required>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $order->fax) }}">
                @if($errors->has('fax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Order::SHIPPING_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('shipping_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="shipping_status_{{ $key }}" name="shipping_status" value="{{ $key }}" {{ old('shipping_status', $order->shipping_status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="text" name="tax" id="tax" value="{{ old('tax', $order->tax) }}">
                @if($errors->has('tax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tracking_number') ? 'is-invalid' : '' }}" type="text" name="tracking_number" id="tracking_number" value="{{ old('tracking_number', $order->tracking_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_shipped') ? 'is-invalid' : '' }}" type="text" name="date_shipped" id="date_shipped" value="{{ old('date_shipped', $order->date_shipped) }}">
