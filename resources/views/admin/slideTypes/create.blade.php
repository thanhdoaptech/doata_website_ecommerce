...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.slideType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.slide-types.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_item') ? 'is-invalid' : '' }}" type="number" name="max_item" id="max_item" value="{{ old('max_item', '') }}" step="1">
