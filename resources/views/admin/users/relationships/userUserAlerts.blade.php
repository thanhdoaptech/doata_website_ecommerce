            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-userUserAlerts">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.userAlert.fields.alert_image') }}
                        </th>
                        <th>
                            {{ trans('cruds.userAlert.fields.alert_file') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($userAlerts as $key => $userAlert)
                        <tr data-entry-id="{{ $userAlert->id }}">
                            ...
                            <td>
                                @foreach($userAlert->alert_image as $key => $media)
                            ...
                            <td>
                                @foreach($userAlert->alert_file as $key => $media)
                                    <a href="{{ $media->getUrl() }}" target="_blank">
